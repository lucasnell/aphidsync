...
// fit_aphids0
double fit_aphids0(arma::vec pars, const arma::mat& known_L_mat, const arma::vec& re, const arma::uvec& time, const double& fecund, SEXP regr_ptr, const bool& match_lambda, const bool& fit_survs, const double& max_shape, const std::string& L_method, const double& L_upper_bound, const double& L_tol, const int& L_max_iters);
